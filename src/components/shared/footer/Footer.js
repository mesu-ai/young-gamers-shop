...
const Footer = () => {
    ...
    return (
        ...
        <Typography variant="subtitle1" gutterBottom component="div">
                &copy; 2021 All Right Served By Young Gamers Shop.
        </Typography>
        <Box>
            <a href="https://www.facebook.com/youngamershop/" target="_blank" rel="noopener noreferrer"><FacebookIcon color="primary" sx={{fontSize:40}}/></a>

            <InstagramIcon color="error" sx={{fontSize:40}}/>

            {/* <LinkedInIcon color="primary" sx={{fontSize:40}}/> */}
            <a href="https://api.whatsapp.com/message/6YDZ2PT7BQV5O1?autoload=1&app_absent=0" target="_blank" rel="noopener noreferrer"><WhatsAppIcon color="success" sx={{fontSize:40}}/></a>
